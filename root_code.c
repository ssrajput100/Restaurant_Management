...
char lunchmenu[][100]={"Veg Biryani","Special meal","Roti","Dal","Paneer Tikka","Veg
mix","Icecream"};
char dinnermenu[][100]={"Fried rice","Spegatti","Burger","Pasta","Noodles","Paratha","Fruit
Salad"};
char choice;
do
{
...
printf("\nNo of digits::%d\n",digits);
printf("All the taxes are inclusive of the price printed ");
while(num!= 0)
{
temp++;
switch(num%10)
